    ...
    <div <?php post_class(); ?>>
        ...
        <div class="entry-container">
            ...
            <div class='entry-meta-bottom'>
                <?php get_template_part('further-reading-jetpack-portfolio'); ?>
                <div class="entry-categories">
                    <?php //$project_categories = get_the_term_list($post->ID,'project_types'); ?>
                    <?php $meta = get_the_term_list( $post->ID, 'jetpack-portfolio-type', 'PROJECT META: ', '' ); 
                    echo $meta;
                    ?>
